...
<script lang="ts">
	...
	import { fileAsURL } from '@/utils/helper'

	// components
	import FilePreview from '@/components/_file-preview.vue'
	import Input from '@/components/form/_input.vue'
	import ProgressBar from '@/components/progress/_bar.vue'
